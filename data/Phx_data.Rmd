...
NHGIS_Data_Rename1 <- left_join(county_st, NHGIS_data, by=c("geoid"="GISJOIN"))
NHGIS_mapdata <- left_join(county_st, NHGIS_data, by=c("geoid"="GISJOIN"))

```

#This code represents my attempt at converting to a GeoJson, which was unsuccessful
#Convert to GeoJson

phx <- readOGR("./shapefiles/tl_2010_04013_tract10/tl_2010_04013_tract10.shp")
...
phx_simplified <- ms_simplify( phx )
