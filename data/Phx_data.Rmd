...
doctoral_2010 <- ggplot(mcpa_educ_2010) + 
  geom_sf(aes(fill=Doctoral_2010)) + geom_polygon() +  coord_map() +
  scale_fill_distiller(palette="Greens", direction=1, name="Population") +
...
twohundredkto250k_value_2010 <- ggplot( data = phx.tidy, 
               aes( x = long, y = lat, 
                    group = group, fill=
Twohundredkto250k_2010)) + geom_polygon() +  coord_map() +
  scale_fill_distiller(palette="BuGn", direction=1, name="Population") +
...
twohundredkto150k_value_2015 <- ggplot( data = phx.tidy, 
               aes( x = long, y = lat, 
                    group = group, fill=
Twohundredkto250k_2015)) + geom_polygon() +  coord_map() +
  scale_fill_distiller(palette="BuGn", direction=1, name="Population") +
