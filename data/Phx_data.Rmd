...
Metadata_2010_ACS5 <- read.csv("./data/2010ACS5DataDictionary.csv")
Metadata_2015_ACS5 <- read.csv("./data/2015ACS5DataDictionary.csv")

#Load time series tables
NHGIS_data <- read.csv("./data/NHGIS_geog_data.csv")
...
race_2015_vars <- read.csv("./data/variable_lists/race_2015_ACS5.csv")
...
sex_vars_2015 <- read.csv("./data/variable_lists/sex_vars_2015.csv")
...
hispanic_vars_2015 <- read.csv("./data/variable_lists/hispanic_vars_2015.csv")
...
educ_2010_vars <- read.csv("./data/variable_lists/educ_2010_vars.csv")
...
###Read csv file with only race variables. I manually created this by cutting and pasting the rows I wanted from the previous spreadsheet. 
educ_2015_vars <- read.csv(".data/variable_lists/educ_2015_vars.csv")
...
income_2010_vars <- read.csv("./data/variable_lists/income_2010_vars.csv")
...
income_2015_vars <- read.csv("./data/variable_lists/income_2015_vars.csv")
...
###Read csv file with only race variables. I manually created this by cutting and pasting the rows I wanted from the previous spreadsheet. 
value_2010_vars <- read.csv(".data/variable_lists/value_vars_2010.csv")
...
### Read csv file with only race variables. I manually created this by cutting and pasting the rows I wanted from the previous spreadsheet. 
value_2015_vars <- read.csv(".data/variable_lists/value_vars_2015.csv")
...
occupancy_vars_2015 <- read.csv("./data/variable_lists/occupancy_vars_2015.csv")
...
vacancy_vars_2015 <- read.csv("./data/variable_lists/vacancy_vars_2015.csv")
...
traveltime_vars_2010 <- read.csv("./data/variable_lists/traveltime_vars_2010.csv")
...
###Read csv file with only travel time to work variables. 
traveltime_vars_2015 <- read.csv("./data/variable_lists /traveltime_vars_2015.csv")
...
## Import Shapefile
county_shp <- " ./shapefiles/tl_2010_04013_tract10.shp"
...
##ACS5
mcpa_race_2010 <- left_join(county_st, race.pop.2010, by=c("GEOID10"="geoid"))
...
mcpa_2010 <- st_join(mcpa_2010, mcpa_educ_2010)
mcpa_2010 <- st_join(mcpa_2010, mcpa_income_2010)
...
mcpa_2015 <- st_join(mcpa_race_2015, mcpa_age_2015)
mcpa_2015 <- st_join(mcpa_2015, mcpa_educ_2015)
