...
NHPI_1990 <- dotsInPolys( phx2 , race.dashboard$NHPI_1990/45, f = "random", offset, compatible = FALSE)
...
points( NHPI_1990, col=adjustcolor("pink", alpha.f=0.2), pch=19, cex=0.7 )
points( SomeOther_1990, col=adjustcolor("darkslategray3", alpha.f=0.2), pch=19, cex=0.7 ) 
legend( "bottomleft", legend= c("White", "Black", "Native American", "Asian", "Pacific Islander", "Some Other Race"), fill=c("firebrick", "goldenrod2", "forestgreen", "darkviolet", "pink", "darkslategray3"), title="Races", box.lty=2, box.col="black", bg="white" )
```
...
PacificIslander_2015 <- dotsInPolys( phx2 , race.dashboard$PacificIslander_2015/100, f = "random", offset, compatible = FALSE)
...
points( PacificIslander_2015, col=adjustcolor("pink", alpha.f=0.2), pch=19, cex=0.7 )
...
legend( "bottomleft", legend= c("White", "Black", "Native American", "Asian", "Pacific Islander", "Some Other Race", "Two Plus Races"), fill=c("firebrick", "goldenrod2", "forestgreen", "darkviolet", "pink", "darkslategray3", "blue"), title="Races", box.lty=2, box.col="black", bg="white" )
```
